...
- ClusterRole with Gatekeeper permissions (see [Kubernetes RBAC](../kubernetes-rbac/))
...
**Next:** [OIDC Integration](../oidc-integration/) | **Previous:** [RGD Development](../rgds-development/)
