...
import { ArrowRight, KeyRound } from "@/lib/icons";
...
interface InstanceExternalRefsProps {
  instance: Instance;
}
...
export function InstanceExternalRefs({ instance }: InstanceExternalRefsProps) {
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2">
      {refsWithKinds.map((ref) => {
        ...
        const isSecret = ref.kind === "Secret";
        return (
          <InstanceMiniCard
            key={ref.id}
