...
// NoopComplianceService is a no-op implementation of ComplianceService for OSS builds.
// All methods indicate the feature is not enabled.
type NoopComplianceService struct{}

// NewNoopComplianceService creates a new no-op compliance service for OSS builds.
func NewNoopComplianceService() *NoopComplianceService {
	return &NoopComplianceService{}
}

// IsEnabled returns false as compliance is an enterprise feature.
func (s *NoopComplianceService) IsEnabled() bool {
	return false
}

// GetStatus returns status indicating this is an OSS build.
func (s *NoopComplianceService) GetStatus() *ComplianceStatus {
	return &ComplianceStatus{
		Available:  false,
		Enterprise: false,
		Message:    "Compliance features require an enterprise license",
	}
}

// ListConstraintTemplates returns an empty list (feature not enabled).
func (s *NoopComplianceService) ListConstraintTemplates(ctx context.Context) ([]ConstraintTemplate, error) {
	return nil, ErrServiceUnavailable
}

// GetConstraintTemplate returns an error (feature not enabled).
func (s *NoopComplianceService) GetConstraintTemplate(ctx context.Context, name string) (*ConstraintTemplate, error) {
	return nil, ErrServiceUnavailable
}

// ListConstraints returns an empty list (feature not enabled).
func (s *NoopComplianceService) ListConstraints(ctx context.Context) ([]Constraint, error) {
	return nil, ErrServiceUnavailable
}

// GetConstraint returns an error (feature not enabled).
func (s *NoopComplianceService) GetConstraint(ctx context.Context, kind, name string) (*Constraint, error) {
	return nil, ErrServiceUnavailable
}

// ListViolations returns an empty list (feature not enabled).
func (s *NoopComplianceService) ListViolations(ctx context.Context) ([]Violation, error) {
	return nil, ErrServiceUnavailable
}

// GetViolationsByConstraint returns an empty list (feature not enabled).
func (s *NoopComplianceService) GetViolationsByConstraint(ctx context.Context, kind, name string) ([]Violation, error) {
	return nil, ErrServiceUnavailable
}

// GetViolationsByResource returns an empty list (feature not enabled).
func (s *NoopComplianceService) GetViolationsByResource(ctx context.Context, kind, namespace, name string) ([]Violation, error) {
	return nil, ErrServiceUnavailable
}

// GetSummary returns an error (feature not enabled).
func (s *NoopComplianceService) GetSummary(ctx context.Context) (*ComplianceSummary, error) {
	return nil, ErrServiceUnavailable
}

// UpdateConstraintEnforcement returns an error (feature not enabled).
func (s *NoopComplianceService) UpdateConstraintEnforcement(ctx context.Context, kind, name, newAction string) (*Constraint, error) {
	return nil, ErrServiceUnavailable
}

// CreateConstraint returns an error (feature not enabled).
func (s *NoopComplianceService) CreateConstraint(ctx context.Context, req CreateConstraintRequest) (*Constraint, error) {
	return nil, ErrServiceUnavailable
}
