...
func TestRGDCache_VisibilityFiltering_PublicRGDs(t *testing.T) {
	...
	cache.Set(&models.CatalogRGD{
		...
		Labels: map[string]string{
			models.RGDProjectLabel: "alpha-team",
		},
		Annotations: map[string]string{
			models.CatalogAnnotation: "true",
		},
	...
	cache.Set(&models.CatalogRGD{
		...
		Namespace: "",
		Labels: map[string]string{
			models.RGDProjectLabel: "beta-team",
		},
		Annotations: map[string]string{
			models.CatalogAnnotation: "true",
		},
...
func TestRGDCache_VisibilityFiltering_ProjectRGDs(t *testing.T) {
	...
	for _, rgd := range result.Items {
		if rgd.Labels[models.RGDProjectLabel] != "alpha-team" {
			t.Errorf("expected alpha-team project, got %s", rgd.Labels[models.RGDProjectLabel])
		}
	}
}
...
func TestRGDCache_VisibilityFiltering_MultipleProjects(t *testing.T) {
	...
	cache.Set(&models.CatalogRGD{
		...
		Namespace: "",
		Labels: map[string]string{
			models.RGDProjectLabel: "gamma-team",
		},
		Annotations: map[string]string{
			models.CatalogAnnotation: "true",
		},
...
func TestRGDCache_OrgFilter_BeforeProjectFilter(t *testing.T) {
	...
	rgd.Organization = "orgB"
	rgd.Labels = map[string]string{models.RGDProjectLabel: "alpha-team"}
	cache.Set(rgd)
