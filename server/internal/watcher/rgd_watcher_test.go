...
func TestRGDWatcher_ShouldIncludeInCatalog(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			annotations: map[string]string{
				models.CatalogAnnotation: "false",
			},
			expected: false,
		},
		{
...
func TestRGDWatcher_UnstructuredToRGD(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation:     "true",
		models.DescriptionAnnotation: "A test RGD for PostgreSQL",
		models.TagsAnnotation:        "database, postgres, aws",
		models.CategoryAnnotation:    "database",
		models.IconAnnotation:        "postgres-icon",
		models.VersionAnnotation:     "v2.0",
	}
...
func TestRGDWatcher_UnstructuredToRGD_TitleAnnotation(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation: "true",
		models.TitleAnnotation:   "Prometheus Monitoring Stack",
	}
...
func TestRGDWatcher_UnstructuredToRGD_TitleEmptyAnnotationFallback(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation: "true",
		models.TitleAnnotation:   "", // Empty title annotation - should fall back to name
	}
...
func TestRGDWatcher_HandleAdd(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation:     "true",
		models.DescriptionAnnotation: "Test RGD",
	}
...
func TestRGDWatcher_HandleUpdate(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation:     "true",
		models.DescriptionAnnotation: "Original",
	}
	...
	newAnnotations := map[string]string{
		models.CatalogAnnotation:     "true",
		models.DescriptionAnnotation: "Updated",
	}
...
func TestRGDWatcher_ListRGDs(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		annotations := map[string]string{
			models.CatalogAnnotation: "true",
			models.CategoryAnnotation: func() string {
				if i%2 == 0 {
					return "database"
				}
				return "cache"
...
func TestRGDWatcher_TagsParsing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.tagsValue != "" {
				annotations[models.TagsAnnotation] = tt.tagsValue
			}
...
func TestRGDWatcher_UpdatedAtTimestamp_ActualChange(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation:     "true",
		models.DescriptionAnnotation: "Original description",
	}
	oldRGD := createTestRGD("test-rgd", "default", annotations, nil)
	watcher.handleAdd(oldRGD)
	...
	newAnnotations := map[string]string{
		models.CatalogAnnotation:     "true",
		models.DescriptionAnnotation: "Updated description",
	}
	newRGD := createTestRGD("test-rgd", "default", newAnnotations, nil)
...
func TestRGDWatcher_OrganizationLabelParsing(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			labels: map[string]string{
				models.RGDOrganizationLabel: "orgA",
			},
			expectedOrg: "orgA",
		},
		{
		...
		},
		{
			...
			labels: map[string]string{
				models.RGDOrganizationLabel: "orgA",
				models.RGDProjectLabel:      "payments",
			},
			expectedOrg: "orgA",
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.labels != nil && tt.labels[models.RGDProjectLabel] != "" {
				if result.Labels[models.RGDProjectLabel] != tt.labels[models.RGDProjectLabel] {
					t.Errorf("expected project label %q, got %q",
						tt.labels[models.RGDProjectLabel], result.Labels[models.RGDProjectLabel])
				}
			}
		})
	}
...
func TestRGDWatcher_DeploymentModesParsing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.modesValue != "" {
				annotations[models.DeploymentModesAnnotation] = tt.modesValue
			}
...
func TestRGDWatcher_DeploymentModes_InvalidModesLogWarning(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation:         "true",
		models.DeploymentModesAnnotation: "gitops,invalid,direct,unknown",
	}
	rgd := createTestRGD("test-rgd", "default", annotations, nil)
...
func TestRGDWatcher_DeploymentModes_HandleAddUpdate(t *testing.T) {
	...
	annotations := map[string]string{
		models.CatalogAnnotation:         "true",
		models.DeploymentModesAnnotation: "gitops",
	}
	rgd := createTestRGD("test-rgd", "default", annotations, nil)
	watcher.handleAdd(rgd)
	...
	newAnnotations := map[string]string{
		models.CatalogAnnotation:         "true",
		models.DeploymentModesAnnotation: "direct,gitops,hybrid",
	}
	newRGD := createTestRGD("test-rgd", "default", newAnnotations, nil)
